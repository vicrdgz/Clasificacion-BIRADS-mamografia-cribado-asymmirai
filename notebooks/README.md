...
**Inputs**: ninguno.
**Outputs**: creación de las carpetas `outputs/{Features, Predicciones, Plots}` si no existen.
...
**Outputs**: `outputs/Features/preprocesado_etapas.png`.
...
- **10 configuraciones** = 5 inputs × 2 poolings.
  ...
  - Poolings: `gg` (GAP + GMP) y `22` (pool adaptativo 2 x 2).
...
Métricas antes/después + DeLong para verificar preservación del AUC + reliability diagrams.
...
- Panel 2×2 con las cuatro vistas estándar de un examen de mamografía de cribado.
